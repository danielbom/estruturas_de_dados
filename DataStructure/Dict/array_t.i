...
void array_t_open_block( array_t* self, int pos ) {
    ...
    for ( int i = n; i > pos; i-- ) {
        void* ptr = ( (self)->_array + ( (self)->_size * (i)));
...
# 83 "../Array/array_t.c"
    ...
    void *pos = ( (self)->_array + ( (self)->_size * (self->_filled++)));
...
# 100 "../Array/array_t.c"
    ...
    memcpy( ( (self)->_array + ( (self)->_size * (pos))), val, self->_size );
    self->_filled++;
}
int_fast16_t array_insort( array_t *self, void* val, int (*cmp)( const void*, const void* ) ) {
    array_assertion( self );
    ...
    for (i = 0; i < n; i++) {
        if ( cmp(val, ( (self)->_array + ( (self)->_size * (i)))) <= 0 ) {
            break;
        }
    }
...
void* array_get( array_t *self, int_fast16_t pos ) {
    ...
    return ( (self)->_array + ( (self)->_size * (pos)));
}
int_fast16_t array_bsearch( array_t *self, void* val, int (*cmp)( const void*, const void* ) ) {
    array_assertion( self );
