...
void teste_primos(){
    ...
    printf("busca primo minha implementacao (eh_primo)\n");
    // Preciso admitir que é cópia do isprime
    printf("busca primo implementacao da internet (isprime)\n");
